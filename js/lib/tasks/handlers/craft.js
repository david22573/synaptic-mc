...
import { findNearestBlockByName, placePortableUtility, makeRoomInInventory, escapeTree, moveToGoal, } from "../utils.js";
import pkg from "mineflayer-pathfinder";
const { goals } = pkg;
export async function handleCraft(ctx) {
    ...
    if (recipes.length === 0) {
        throw new Error(`MISSING_INGREDIENTS_OR_CRAFTING_TABLE_FOR_${targetName.toUpperCase()}`);
    }
